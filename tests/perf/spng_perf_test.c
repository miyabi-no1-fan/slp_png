...
const char path_out[] = "tests/test_images/new_spng.png";
...
int encode_image(void *image, size_t length, uint32_t width, uint32_t height, enum spng_color_type color_type, int bit_depth, FILE *fout)
{
    int fmt;
    int ret = 0;
    spng_ctx *ctx = NULL;
